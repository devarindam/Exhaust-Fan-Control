...
// ============================================
#define WIFI_SSID       "PGCB"
#define WIFI_PASSWORD   "pgcb1234"
...
// Timing (milliseconds)
// ============================================
#define SENSOR_INTERVAL     3000    // Read sensor every 3 seconds
#define BROADCAST_INTERVAL  2000    // Broadcast status every 2 seconds
#define LCD_UPDATE_INTERVAL 1000    // Refresh LCD once per second
#define LCD_ROW2_INTERVAL_MS 4000   // Row 2 cycles between thresholds and IP/signal every 4 seconds
