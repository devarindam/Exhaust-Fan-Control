...
<head>
    ...
    <meta name="description" content="Smart Fan Controller â€” Premium IoT Dashboard for ESP32-based temperature-controlled fan system.">
    ...
    <style>
        *, *::before, *::after {
        ...
        /* â”€â”€ Card Base â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .card {
            background: var(--card-bg);
            border: 1px solid var(--card-border);
            border-radius: 20px;
        ...
        /* â”€â”€ Temperature Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .temp-card {
            display: flex;
        ...
        /* â”€â”€ Temperature Gradient Bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .temp-bar-container {
            width: 100%;
            margin-top: 20px;
            position: relative;
        ...
        /* â”€â”€ Fan Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .fan-card {
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        /* â”€â”€ Alert Banners â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .alert-banner {
            display: flex;
            align-items: center;
            gap: 16px;
        ...
        /* â”€â”€ Password Modal & Lock Overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        .modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    <div class="container">
        ...
        <div id="alarmBanner" class="alert-banner alarm-banner hide">
            <span class="icon" style="font-size: 20px;">ðŸ”¥</span>
        ...
        <div id="faultBanner" class="alert-banner fault-banner hide">
            <span class="icon" style="font-size: 20px;">âš ï¸</span>
        ...
        <div class="dashboard-grid">
            ...
            <section class="card temp-card" aria-label="Temperature and Humidity">
                ...
                <div>
                    <span id="tempValue" class="temp-value">--</span><span class="temp-unit">Â°C</span>
                </div>
        ...
        <!-- Controls Card -->
        <section class="card controls-card card-full" aria-label="Controls">
            ...
            <div class="control-row">
                ...
                <div class="control-right">
                    <div class="mode-toggle">
                        <button id="btnAuto" class="mode-btn active" onclick="setMode(true)">AUTO</button>
                        <button id="btnManual" class="mode-btn" onclick="setMode(false)">MANUAL</button>
                    </div>
                </div>
            </div>
            ...
            <div class="control-row">
                ...
                <div class="control-right">
                    <div class="power-btn-wrapper">
                        <button id="powerBtn" class="power-btn disabled" onclick="handlePowerClick(event)" aria-label="Toggle Fan Power">
            ...
            <div id="thresholdRow" class="control-row">
                <div class="control-label" style="cursor: pointer; display: flex; align-items: center; gap: 6px;" onclick="openPasswordModal()">
                    Threshold <span id="thresholdLockIcon" style="font-size: 11px;">ðŸ”’</span>
                </div>
                <div class="control-right">
                    <div class="slider-group" id="thresholdSliderGroup" style="position: relative;">
                        ...
                        <input type="range" id="thresholdSlider" min="18" max="40" step="0.5" value="28" oninput="updateThreshold(this.value)">
                        <span id="thresholdValue" class="slider-value">28.0Â°C</span>
                    </div>
                </div>
            </div>
            ...
            <div id="hysteresisRow" class="control-row">
                <div class="control-label" style="cursor: pointer; display: flex; align-items: center; gap: 6px;" onclick="openPasswordModal()">
                    Hysteresis <span id="hysteresisLockIcon" style="font-size: 11px;">ðŸ”’</span>
                </div>
                <div class="control-right">
                    <div class="slider-group" id="hysteresisSliderGroup" style="position: relative;">
                        ...
                        <input type="range" id="hysteresisSlider" min="0.5" max="5" step="0.5" value="2" oninput="updateHysteresis(this.value)">
                        <span id="hysteresisValue" class="slider-value">2.0Â°C</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="card status-bar card-full" aria-label="System Status" style="margin-top:24px; padding:18px 28px;">
            <div class="status-item">
                ...
                <span id="ipValue" class="value">â€”</span>
            </div>
            <div class="status-item">
                <span class="label">Signal</span>
                <span id="rssiValue" class="value">â€” dBm</span>
            </div>
            <div class="status-item">
                <span class="label">Uptime</span>
                <span id="uptimeValue" class="value">â€”</span>
            </div>
        </section>
    </div>
    ...
    <div id="passwordModal" class="modal-overlay hide" onclick="closePasswordModal(event)">
        <div class="modal-card" onclick="event.stopPropagation()">
            ...
            <div id="passwordError" class="password-error hide">âŒ Invalid password. Please try again.</div>
    ...
    <script>
        ...
        /* â”€â”€ Fan Physics Simulation (Inertia + Motion Blur) â”€â”€ */
        let fanAngle = 0;
        ...
        /* â”€â”€ WebSocket Connection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        function connect() {
            ...
            ws.onclose = function() {
                ...
                isAuthenticated = false;
                document.getElementById('thresholdLockIcon').textContent = 'ðŸ”’';
                document.getElementById('hysteresisLockIcon').textContent = 'ðŸ”’';
        ...
        /* â”€â”€ Dashboard Update â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        function updateDashboard(data) {
            ...
            document.getElementById('thresholdValue').textContent = parseFloat(data.threshold).toFixed(1) + 'Â°C';
            document.getElementById('hysteresisSlider').value = data.hysteresis;
            document.getElementById('hysteresisValue').textContent = parseFloat(data.hysteresis).toFixed(1) + 'Â°C';
        ...
        /* â”€â”€ Mode UI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        ...
        /* â”€â”€ Settings Security â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        ...
        function updateThreshold(val) {
            ...
            document.getElementById('thresholdValue').textContent = parseFloat(val).toFixed(1) + 'Â°C';
        }
        ...
        function updateHysteresis(val) {
            ...
            document.getElementById('hysteresisValue').textContent = parseFloat(val).toFixed(1) + 'Â°C';
        }

        /* â”€â”€ Power Button Handler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
